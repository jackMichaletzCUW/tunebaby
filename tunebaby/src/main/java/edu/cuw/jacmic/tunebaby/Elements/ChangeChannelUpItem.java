...
public class ChangeChannelUpItem implements ClickableItem {
	...
	public ChangeChannelUpItem(ImageMap parent) {
		icons[0] = parent.getNormalIcon(parent.CHANGE_CHANNEL_UP);
		icons[1] = parent.getPressedIcon(parent.CHANGE_CHANNEL_UP);
		
		int[] dimensions = parent.getTagDimensions(parent.CHANGE_CHANNEL_UP);
